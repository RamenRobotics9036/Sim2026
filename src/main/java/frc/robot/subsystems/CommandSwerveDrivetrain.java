...
public class CommandSwerveDrivetrain extends TunerSwerveDrivetrain implements Subsystem {
     ...
     *
     * <p>This constructs the underlying hardware devices, so users should not construct
    ...
    public void periodic() {
         ...
         * apply it regardless of DS state.  This allows us to correct the perspective
         * in case the robot code restarts mid-match.  Otherwise, only check and
         * apply the operator perspective if the DS is disabled.  This ensures driving
         * behavior doesn't change until an explicit disable event occurs during testing.
         */
     ...
     *
     * <p>Measurements with timestamps near the last pose reset are ignored to prevent
     * stale vision data from corrupting the freshly reset pose.
     *
     * <p><b>Why we filter vision measurements around pose resets:</b>
     *
     * <p>There is a timing issue where vision measurements captured BEFORE a pose reset can be
     * processed and injected AFTER the reset occurs. Here's the sequence that causes problems:
     * <ol>
     *   <li>Camera captures frame at time T=1.0s, sees AprilTags, calculates robot at (5, 3)</li>
     *   <li>User presses reset button at T=1.05s during CommandScheduler.run()</li>
     *   <li>drivetrain.resetPose() called, setting pose to (0, 0) and clearing Kalman filter</li>
     ...
     * </ol>
     *
     * <p>The fix: Ignore any vision measurements with timestamps within a window around the last
     ...
     * while still accounting for measurement noise.
     *
     * <p>Measurements with timestamps before the last pose reset are ignored to prevent
     * stale vision data from corrupting the freshly reset pose.
     *
     * @param visionRobotPoseMeters The pose of the robot as measured by the vision camera.
     * @param timestampSeconds The timestamp of the vision measurement in seconds (FPGA time).
