...
/**
 * Interface for ground truth simulation functionality.
 * Provides methods to track and manipulate the simulated robot's actual position
 * independently of odometry drift.
 */
public interface GroundTruthSimInterface {
     ...
     * If a timeout elapses between calls, restarts from the beginning.
     *
